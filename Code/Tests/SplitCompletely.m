...
Commentary:  nohup cat /home/adela/ThueMahler/Data/SUnitEqData/TMFormData.csv | parallel -j1 --joblog splittmplog magma set:={} /home/adela/ThueMahler/Code/SplitCompletely.m 2>&1 &
...
SUnitErr:= "/home/adela/ThueMahler/Data/SplitCompletelyErr.csv";
...
if r eq 2 then
	...
	if #fprs eq 3 then
	    printf hash cat "," cat IntegerToString(p) cat "\n";
	end if;
