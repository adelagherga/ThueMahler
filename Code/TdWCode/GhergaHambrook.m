...
Description: Thue-Mahler solver incorporating the new PIRL and principalization algorithms
...
//////////////////////////////////////////////////////////////////////
/*
Define the algorithm we need
*/
///////////////////////////////////////////////////////////////////////

algs1and2:= function(OK,f,th,p,fprs,efp,ffp)
   ...
   */
    ...
    while #ulist ne 0 do
	    ...
	    // determine indices of prime ideals satisfying criteria of P_u of Algorithm 3.3.3
            cPu:=[i : i in [1..#fprs] | Valuation((u-th)*OK,fprs[i]) ge t*efp[i]];
	    // determine all exponents in b_u of Algorithm 3.3.3
            fbu:= [ Min([Valuation((u-th)*OK,fprs[i]),t*efp[i]]) : i in [1..#fprs]];
    ...
    while #ulist ne 0 do
	    ...
	    // determine indices of prime ideals satisfying criteria of P_u of Algorithm 3.3.4
            cPu:=[i : i in [1..#fprs] | Valuation(1-u*th,fprs[i]) ge t*efp[i]];
	    // determine all exponents in b_u of Algorithm 3.3.4
            fbu:= [ Min([Valuation(1-u*th,fprs[i]),t*efp[i]]) : i in [1..#fprs]];
...
for L:=1 to v do
    // NEW METHOD - populate ListOfTuplesOfExponentsForPrimesDividingbbAbovep[L]

    ListOfTuplesOfExponentsForPrimesDividingbbAbovep[L]:=
	algs1and2(OK,g,theta,p[L],pp[L],e[L],f[L]);
    // END OF NEW METHOD
