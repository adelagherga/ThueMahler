...
Description: This program iterates through "TMFormData.csv" and "NoSUnitEqNeeded.csv" to
	     regenerate all Thue equations to be solved. The output is printed in
	     "ThueEqToSolve.csv" and supercedes the same-named file generated by
	     "GenerateSUnitEquations.m", which is now rendered obsolete.
...
Commentary:  This algorithm only needs to be applied once to each of "TMFormData.csv" and
	     "NoSUnitEqNeeded.csv".
...
SUnitErr:= "/home/adela/ThueMahler/Data/SUnitEqData_Alpha/RegernerateThueErr.txt";
