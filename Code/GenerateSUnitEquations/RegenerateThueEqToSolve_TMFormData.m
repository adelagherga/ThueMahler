...
Description: This program iterates through "TMFormData.csv" to
	     regenerate all Thue equations to be solved and simultaneously outputs all a
	     values and their corresponding primelists per (optimal) Thue-Mahler form. The
	     output is printed in "RegeneratedThueEqToSolve.csv" and will supercede the
	     file "ThueEqToSolve.csv" generated by "GenerateSUnitEquations.m", which is
	     ...
	     original Thue-Mahler form.
             ...
             In addition to regenerating all Thue equations, this algorithm also outputs, for
...
SUnitEq:= "/home/adela/ThueMahler/Data/SUnitEqData/RegeneratedTMFormData.csv";
